...
void man(char *name)
{
    ...
    {
        printf("Description : Used to read date from regular file \n");
    ...
    else if (strcmp(name, "truncate") == 0)
    {
        ...
        printf("Usage : trincate File_name\n");
    }
...
void DisplayHelp()
{
    ...
    printf("closeall : To close all opened fiels \n");
...
void CreateCVFS()
{
    ...
    printf("CVFS created successfully\n");
}
...
void ls_file()
{
    ...
    printf("\nFileName\tINODE number\tFile size\tLinkCount\n");
    printf("-------------------------------------------------------------------------------------\n");
    while (temp != NULL)
    {
        if (temp->FileType != 0)
    ...
    while (1)
    {
        ...
        else if (count == 2)
        {
            ...
            else if (strcmp(command[0], "write") == 0)
            {
                ...
                if (ret == -3)
                    printf("ERROR : it is nor=t regular file\n");
            }
        }
